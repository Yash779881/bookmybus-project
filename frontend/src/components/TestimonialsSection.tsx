...
const testimonials = [
  {
    ...
    content: "BookMyBus made my journey from Delhi to Jaipur so smooth. Real-time tracking and comfortable buses. Highly recommended!"
  },
  {
    name: "Rajesh Kumar",
  ...
  },
  {
    ...
    content: "Affordable prices and reliable service. I travel from Mumbai to Pune every weekend and BookMyBus never disappoints."
  },
  {
    name: "Suresh Reddy",
    role: "Senior Citizen",
      ...
      <div className="container px-4">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">
            Join thousands of satisfied travelers on BookMyBus
          </p>
        </motion.div>
